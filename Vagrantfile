...
#  config.vm.box = "Ubuntu12.0.4"
  ...
  config.vm.hostname = "johnfitzpatrick-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/learnchef2"
  #   chef.validation_client_name = "learnchef2-validator"
  #   chef.validation_key_path = ".chef/learnchef2-validator.pem"
  # end
end
